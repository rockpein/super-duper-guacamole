...
def listofmovies():
    ...
    result = c.fetchall()
    output = template('templates/list_of_movies', rows=result)
    return output
...
def top1000():
    ...
    result = c.fetchall()
    output2 = template('templates/top1000', rows=result)
    return output2
...
def top100y():
    ...
    if release_year == "":
        ...
        result = c.fetchall()
        output = template('templates/top100year', rows=result,date=release_year + " - " + str(int(release_year)+ 9))
        return output
...
def top100g():
    ...
    if genre == "":
        ...
        result = c.fetchall()
        output = template('templates/top100genre', rows=result)
        return output
